...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void respond(String input) throws IOException {
        ...
        try {
            ...
            if (bot.getIntent().equals(prevIntent) && !(prevIntent.equals("Default Fallback Intent") || prevIntent.equals("Search") || prevIntent.equals("Interests") || bot.getAction().contains("smalltalk"))) {
